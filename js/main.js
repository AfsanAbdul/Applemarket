...
$(function () {
    var arrImg = ["img/Layer 18.png", "img/mac-png-7.png", "img/ipad.png", "img/iphone-x.png", "img/ipod.png"];
...
/*header slide*/
$(function () {
    var arrimage = ["img/Layer 18.png", "img/mac-png-7.png", "img/ipad.png"];
...
$('.triangle-move').click(function () {
    $('.triangle').animate({
        'top': '125px'
    },500);
});
$('.clss1').click(function () {
    $('.triangle').animate({
        'top': '45px'
    },500);
});
$('.clss2').click(function () {
    $('.triangle').animate({
        'top': '195px'
    },500);
});
